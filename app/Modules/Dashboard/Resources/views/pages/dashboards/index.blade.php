<x-default-layout>
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="{{locale_route('dashboard')}}" class="text-muted text-hover-primary">Home</a>
        </li>
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <x-Dashboard::buttons.modal-button type="primary" target="kt_modal_new_target">
            Add Target
        </x-Dashboard::buttons.modal-button>
        <!--end::Primary button-->

        <x-Dashboard::buttons.button type="secondary" href="/users">Test</x-Dashboard::buttons.button>
    </div>
    @endsection

    <!--begin::Modals-->
    {{-- <x-modal id="kt_modal_new_target" title="">
