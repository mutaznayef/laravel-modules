                    ...
                    <div class="card-body pb-0">
                        ...
                        <form class="position-relative mb-6">
                            <textarea class="form-control border-0 p-0 pe-10 resize-none min-h-25px"
                                data-kt-autosize="true" rows="1" placeholder="Reply.." data-kt-initialized="1"
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="mb-7">
                            ...
                            <div class="text-gray-800 mb-5">Outlines keep you honest. They stop you from indulging in
                                poorly
                                thought-out metaphors about driving and keep you focused on the overall structure of
                                your
                                post</div>
                            <!--end::Text-->
                            <!--begin::Toolbar-->
                                    ...
                                    <g id="SvgjsG1302" class="apexcharts-inner apexcharts-graphical"
                                        ...
                                        <defs id="SvgjsDefs1301">
                                            ...
                                            <clipPath id="gridRectMask0uln9mrpk">
                                                <rect id="SvgjsRect1310" width="392.80078125" height="282.73" x="-3"
                                            ...
                                            <clipPath id="gridRectMarkerMask0uln9mrpk">
                                                <rect id="SvgjsRect1311" width="390.80078125" height="284.73" x="-2"
                                                    y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none"
                                                    stroke-dasharray="0" fill="#fff"></rect>
                                            </clipPath>
                                        </defs>
                                        <rect id="SvgjsRect1309" width="9.67001953125" height="280.73" x="0" y="0"
                                            rx="0" ry="0" opacity="1" stroke-width="0" stroke-dasharray="3"
                                            fill="url(#SvgjsLinearGradient1305)" class="apexcharts-xcrosshairs"
                                        ...
                                        <g id="SvgjsG1345" class="apexcharts-grid">
                                            <g id="SvgjsG1346" class="apexcharts-gridlines-horizontal">
                                                <line id="SvgjsLine1350" x1="0" y1="70.1825" x2="386.80078125"
                                                    y2="70.1825" stroke="#f1f1f2" stroke-dasharray="4"
                                                    stroke-linecap="butt" class="apexcharts-gridline"></line>
                                                <line id="SvgjsLine1351" x1="0" y1="140.365" x2="386.80078125"
                                                    y2="140.365" stroke="#f1f1f2" stroke-dasharray="4"
                                                    stroke-linecap="butt" class="apexcharts-gridline"></line>
                                            ...
                                            <line id="SvgjsLine1354" x1="0" y1="1" x2="0" y2="280.73"
                                                stroke="transparent" stroke-dasharray="0" stroke-linecap="butt"></line>
                                        </g>
                                        ...
                                        <g id="SvgjsG1348" class="apexcharts-grid-borders">
                                            <line id="SvgjsLine1349" x1="0" y1="0" x2="386.80078125" y2="0"
                                        ...
                                        <line id="SvgjsLine1357" x1="0" y1="0" x2="386.80078125" y2="0"
                                        ...
                                        <g id="SvgjsG1358" class="apexcharts-xaxis" transform="translate(0, 0)">
                                            <g id="SvgjsG1359" class="apexcharts-xaxis-texts-g"
                                                transform="translate(0, -4)"><text id="SvgjsText1361"
                                                    font-family="inherit" x="32.2333984375" y="309.73"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid select2-hidden-accessible"
                                                ...
                                                class="select2 select2-container select2-container--bootstrap5"
                                                dir="ltr" data-select2-id="select2-data-12-wnpa"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--multiple form-select form-select-solid"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="-1" aria-disabled="false">
                                                        <ul class="select2-selection__rendered"
                                                            id="select2-lapv-container">
                                                        </ul><span
                                                            class="select2-search select2-search--inline"><textarea
                                                                class="select2-search__field" type="search" tabindex="0"
                                                                autocorrect="off" autocapitalize="none"
